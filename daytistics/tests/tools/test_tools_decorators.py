...
class TestInternalOnly:
    ...
    @pytest.mark.parametrize("allowed_hosts, remote_addr, expected_result", [
    ...
    def test_internal_only_parametrized(self, rf, mock_view, allowed_hosts, remote_addr, expected_result):
