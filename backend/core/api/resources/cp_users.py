...
#             except errors.TemporarilyRejectedError:
#                 return {"error": "Temporarily rejected"}, 403
#             except errors.VerificationFailureLimitExceededError:
#                 return {"error": "Too many failures"}, 403
...
#                 or not args["username"].strip()
#                 or not args["email"].strip()
#                 or not args["password"].strip()
#             ):
...
#         )
#         self.parser.add_argument(
#             "new_username", type=str, required=True, help="New username is required"
#         )
...
#                 "verification_rejections": user.verification_rejections,
#                 "rejection_duration": user.rejection_duration,
...
# class ResendRegistrationRequest(BaseResource):
#     def __init__(self):
#         super().__init__()
#         self.parser.add_argument(
#             "email", type=str, required=True, help="Email is required"
...
#             return {"message": "Registration request resent"}, 200
#         except Exception as e:
#             self.handle_exception(e, args)
