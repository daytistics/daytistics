...
def create_daytistic(user_id,
                     ...
                     recreation,
                     gratitude):
    daytistic = Daytistic(user_id=user_id, date=date, time_use=time_use, mood=mood, productivity=productivity,
                          happiness=happiness, stress=stress, recreation=recreation, gratitude=gratitude)
