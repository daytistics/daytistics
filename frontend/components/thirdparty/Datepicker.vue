<template>
    <VueDatePicker v-model="date" auto-apply :max-date="new Date()" :enable-time-picker="false"
...
const date = useState<Date | null>('datepickerValue', () => null as Date | null);
