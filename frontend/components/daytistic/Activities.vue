<template>
    ...
    <div v-if="daytistic">
        <div class="flex items-center mb-6">
            ...
            <button data-modal-target="add-activity-modal" data-modal-show="add-activity-modal" @click="openModal"
        ...
        <ul class="bg-gray-50 rounded-lg shadow-sm overflow-hidden">
            <li v-for="(activity, index) in daytistic?.activities" :key="activity.id" class="group">
                <div class="px-6 py-4 flex items-center justify-between hover:bg-gray-100 transition duration-150 ease-in-out cursor-pointer"
                    :class="{
...
function openModal() {
    const modalElement = document.getElementById('add-activity-modal') as HTMLElement;
